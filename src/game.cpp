...
Game::Game() : background(800, 750)  // ⭐ Khởi tạo hiệu ứng nền
{
...
void Game::Update() {
    if(run) {
        background.Update();  // ⭐ Cập nhật hiệu ứng nền
...
void Game::Draw() {
    ClearBackground(Color{10, 10, 20, 255}); // Nền xanh đậm
    background.Draw(); // ⭐ Vẽ hiệu ứng sao rơi
